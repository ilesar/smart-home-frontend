...
@Component({
  name: 'GroceryItemMobileFormEdit',
  components: {
    Camera,
  },
})
export default class GroceryItemMobileFormEdit extends Vue {
  @Prop()
  private submitButtonText!: string;
  @Prop()
  private submitButtonCallback!: (form: GroceryItemMobileFormEdit, model: GroceryItem) => void;
  @Prop()
